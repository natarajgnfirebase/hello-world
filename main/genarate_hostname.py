...
def main():
    ...
    parser.add_argument("--pb_vmaas_env", type=str, required=True, help="pb_vmaas_env")
    parser.add_argument("--pb_vmaas_provider", type=str, required=True, help="pb_vmaas_provider")
    parser.add_argument("--pb_vmaas_zone", type=str, help="pb_vmaas_zone")
    parser.add_argument("--pb_vmaas_image", type=str, required=True, help="pb_vmaas_image")
    parser.add_argument("--pb_vmaas_os_version", type=str, help="pb_vmaas_os_version")
    parser.add_argument("--pb_vmaas_vmcount", type=int, default=1, help="pb_vmaas_vmcount")
    ...
    pb_vmaas_vmcount = args.pb_vmaas_vmcount

    provider_prefix = g_vmaas_provider_prefix.get(pb_vmaas_provider, "unknown")
    os_type = g_vmaas_os_distros.get(pb_vmaas_image, {}).get("os_type", "linux")
